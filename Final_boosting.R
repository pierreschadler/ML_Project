...
test_data.errors <- data.frame(tree = 0, bagging = 0, randomforest = 0, boost1 = 0,
...
postResample(pred = as.numeric(fitboost1.predtrain_data), obs = as.numeric(train_data$RV))
fitboost2.predtrain_data <- as.factor(predict(fitboost2,newdata = train_data, n.trees = fitboost2.optTrees))
postResample(pred = as.numeric(fitboost2.predtrain_data), obs = as.numeric(train_data$RV))
fitboost3.predtrain_data <- as.factor(predict(fitboost3,newdata = train_data, n.trees = fitboost3.optTrees))
postResample(pred = as.numeric(fitboost3.predtrain_data), obs = as.numeric(train_data$RV))
fitboost4.predtrain_data <- as.factor(predict(fitboost4,newdata = train_data, n.trees = fitboost4.optTrees))
postResample(pred = as.numeric(fitboost4.predtrain_data), obs = as.numeric(train_data$RV))
fitboost5.predtrain_data <- as.factor(predict(fitboost5,newdata = train_data, n.trees = fitboost5.optTrees))
postResample(pred = as.numeric(fitboost5.predtrain_data), obs = as.numeric(train_data$RV))
...
postResample(pred = as.numeric(fitboost1.predtest_data), obs = as.numeric(test_data$RV))
fitboost2.predtest_data <- as.factor(predict(fitboost2,newdata = test_data, n.trees = fitboost2.optTrees))
postResample(pred = as.numeric(fitboost2.predtest_data), obs = as.numeric(test_data$RV))
fitboost3.predtest_data <- as.factor(predict(fitboost3,newdata = test_data, n.trees = fitboost3.optTrees))
postResample(pred = as.numeric(fitboost3.predtest_data), obs = as.numeric(test_data$RV))
fitboost4.predtest_data <- as.factor(predict(fitboost4,newdata = test_data, n.trees = fitboost4.optTrees))
postResample(pred = as.numeric(fitboost4.predtest_data), obs = as.numeric(test_data$RV))
fitboost5.predtest_data <- as.factor(predict(fitboost5,newdata = test_data, n.trees = fitboost5.optTrees))
postResample(pred = as.numeric(fitboost5.predtest_data), obs = as.numeric(test_data$RV))
...
cm <-postResample(pred = as.numeric(fitboost1.refit.predtest_data), obs = as.numeric(test_data$RV))
...
cm <-postResample(pred = as.numeric(fitboost2.refit.predtest_data), obs = as.numeric(test_data$RV))
...
cm <-postResample(pred = as.numeric(fitboost3.refit.predtest_data), obs = as.numeric(test_data$RV))
...
cm <-postResample(pred = as.numeric(fitboost4.refit.predtest_data), obs = as.numeric(test_data$RV))
...
cm <-postResample(pred = as.numeric(fitboost5.refit.predtest_data), obs = as.numeric(test_data$RV))
